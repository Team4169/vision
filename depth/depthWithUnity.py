...
server_socket.bind(('localhost', 12345))  # Use the appropriate IP address and port
...
with dai.Device(pipeline) as device:
    ...
    while True:
        ...
        disp_serialized = base64.b64encode(disp.tobytes())
        connection.sendall(disp_serialized)
