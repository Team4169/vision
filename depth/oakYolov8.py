...
parser.add_argument("-conf", "--config", help="Trained YOLO json config path", default='/home/jetson/vision/depth/2023Yolov8DepthAIToolsresult/combinedyolov8.json', type=str)
