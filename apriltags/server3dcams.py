...
#<Init datatables> vdef robotInit() -> None:

inst = ntcore.NetworkTableInstance.getDefault()

table = inst.getTable("datatable")

wPub = table.getDoubleTopic("w").publish()
xPub = table.getDoubleTopic("y").publish()
yPub = table.getDoubleTopic("x").publish()
rPub = table.getDoubleTopic("r").publish()
aPub = table.getDoubleTopic("a").publish()
