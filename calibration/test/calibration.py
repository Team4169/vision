...
# calibration.py will go through saved images, allow you to check them and delete if they are bad,
# then run math stuff to get the camera params and distortian values and save those files.
